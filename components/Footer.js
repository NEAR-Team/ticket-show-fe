        ...
        <div className="flex flex-wrap md:text-left text-center order-first">
          <div className="lg:w-1/5 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li className="mb-2">
                <a className=" hover:text-white">Start selling</a>
              </li>
              <li className="mb-2">
          ...
          <div className="lg:w-1/5 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li className="mb-2">
                <a className=" hover:text-white">About B-Ticket</a>
              </li>
              <li className="mb-2">
                <a className=" hover:text-white">Get B-Ticket token</a>
              </li>
              <li className="mb-2">
            ...
            <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                <label htmlFor="footer-field" className="leading-7 text-sm ">
                  Stay updated. Join our mailinglist.
                </label>
                <input
                  type="text"
                  id="footer-field"

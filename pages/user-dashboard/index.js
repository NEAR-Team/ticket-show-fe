...
export default function UserDashboard() {
  ...
  const activeContract = async (prefix) => {
    ...
    await contract.new({ owner_id: accountId });
  };
    ...
    <div className="bg-white min-h-screen">
      <div className="container mx-auto py-10">
        ...
        <div className="space-x-1">
          ...
          <button
            className="bg-blue-500 text-white px-4 py-2 rounded"
            onClick={() => handleGetShowMetadata("show1", "son_tung_mtp_1")}
          >
            Get Show Metadata
          </button>
          <button
            className="bg-blue-500 text-white px-4 py-2 rounded"
            onClick={() => handleBuyTicket("show1", "son_tung_mtp_1", "vip")}
          >
            Buy ticket
          </button>
